...
# 👨‍⚕️ "Tech Stack Corner" - Auto-Lead Capture Agent
...
print("📚 SELLING: Tech Stack Corner's Cloud & AI Courses")
...
# Default FAQ data for "Tech Stack Corner"
DEFAULT_FAQ = [
    {
    ...
    },
    {
        ...
        "answer": "Yes! Tech Stack Corner releases weekly tutorials on YouTube for free. The paid courses offer deep-dives, code reviews, and certification."
    },
    {
...
class SDRAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions=f"""
            You are 'Sarah', a friendly and professional Sales Development Rep (SDR) for 'Tech Stack Corner'.
            ...
            🚫 **RESTRICTIONS:**
            - If you don't know an answer, say "I'll check with the Tech Stack Corner team and email you." (Don't hallucinate prices).
            """,
